...
const API_KEY = "-QPl11oKmKSmT7oKLPv_LfmA4-BCletMeVwD9f61KU_HMHwdJXc7Ga30WVC7DekqMtCC0REsmrv75hMStbCGj1NiWiYTGFFx1IDbcGbQcL1Kk4YL4i9wvCB580U9YHYx";
...
async function getBizData() {
  try {
    const response = await yelpREST(`https://api.yelp.com/v3/businesses/search?term=eleven madison&location=new york`)
    let id_res = await response
    const data = await yelpREST(`https://api.yelp.com/v3/businesses/${id_res.data.businesses[0].id}`)
